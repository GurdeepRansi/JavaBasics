...
public class AssignmentOperators {
		...
		/* Assignment Operator is denoted by the symbol “=” and it is the most commonly used operator. 
		 * it simply assigns the value on the right to the variable on the left. Syntax of the assignment 
		...
		static String name = "Java"; // name variable gets the value Java
		...
		public static void main(String[] args) {
			...
			//speed = "QA Course"; //String can not be assign to integer
			//name = 10; // Integer can not be assign to String
			//isGood = "QA Course" // String can not be assign to Boolean
